...
# By caching we avoid loading the templates every time render_field
# is called without a templates
@lru_cache()
...
def render_field(  # noqa: C901
    ...
    **kwargs
    ...
    :param field: Can be a string or a Layout object like `Row`. If it's a layout
        ...
        and render it using default templates 'CRISPY_TEMPLATE_PACK/field.html'
    ...
    :templates: Template used for rendering the field.
    ...
    :template_pack: Name of the templates pack to be used for rendering `field`
...
def render_crispy_form(form, helper=None, context=None):
    ...
    This function wraps the templates logic in a function easy to use in a Django view.
    """
