...
class BasicNode(template.Node):
    ...
    templates tags. I created this because most of the tags we'll be using
    ...
    def get_render(self, context):
        ...
        :param context: `django.templates.Context` variable holding the context for the node
    ...
    def get_response_dict(self, helper, context, is_formset):
        """
        Returns a dictionary with all the parameters necessary to render the form/formset in a templates.

        :param context: `django.templates.Context` for the node
...
class CrispyFormNode(BasicNode):
    def render(self, context):
        ...
        if self.actual_helper is not None and getattr(self.actual_helper, "templates", False):
